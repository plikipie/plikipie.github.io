  ...
  return (
    <PageWrapper>
      <div ref={ref} style={{ maxWidth: 680, margin: "0 auto", padding: "7rem 1.5rem 5rem" }}>
        ...
        <a data-sr href="https://hermawanprastiyanto@gmail.com" style={{ display: "inline-flex", alignItems: "center", gap: ".45rem", color: t.accent, fontFamily: "monospace", fontWeight: 700, fontSize: ".92rem", marginBottom: "2.5rem", textDecoration: "none", ...srStyle(240) }}>→ hermawanprastiyanto@gmail.com</a>

        <div data-sr style={{ border: `1px solid ${t.border}`, borderRadius: 14, padding: "2rem", background: t.bgMuted, ...srStyle(320) }}>
          {status === "success" ? (<div style={{ textAlign: "center", padding: "2.5rem 0" }}><div style={{ color: t.accent, fontFamily: "monospace", fontWeight: 800, fontSize: "1.1rem", marginBottom: ".5rem" }}>✓ Message sent</div><div style={{ color: t.textFaint, fontFamily: "monospace", fontSize: ".8rem" }}>I'll get back to you within 24 hours.</div></div>) : (
