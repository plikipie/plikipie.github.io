  ...
  return (
    <PageWrapper>
      <div ref={ref} style={{maxWidth:680,margin:"0 auto",padding:"7rem 1.5rem 5rem"}}>
        ...
        <a data-sr href="https://hermawanprastiyanto.com" style={{display:"inline-flex",alignItems:"center",gap:".45rem",color:"#22c55e",fontFamily:"monospace",fontWeight:700,fontSize:".92rem",marginBottom:"2.5rem",textDecoration:"none",...srStyle(240)}}>→ hermawanprastiyanto.com</a>
